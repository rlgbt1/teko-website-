  ...
  en: {
    ...
    stats: {
      ...
      identity: {
        ...
        items: [
          { stat: '73%', desc: 'of customers question credibility after a poor website.' },
          { stat: '57%', desc: 'of businesses remain invisible online, without a website.' },
          { stat: '88%', desc: 'of customers don’t return after a bad first experience.' },
          { stat: '3h+', desc: 'lost in efficiency weekly with disconnected tools.' },
        ],
      },
      analytics: {
        label: 'AI for business departments',
        items: [
          { stat: '40%', desc: 'of businesses spend more time processing data manually than using it.' },
          { stat: '2.5x', desc: 'more likely to hit targets with real-time data.' },
          { stat: '68%', desc: 'of businesses decide “on gut feeling,” not data.' },
          { stat: '1 in 3', desc: 'corporate processes have manual errors.' },
        ],
      },
    },
    mission: {
    ...
    packages: {
      kicker: 'Digital Identity packages',
      title: 'Three ways to structure the partnership',
      subtitle: 'Sold as fixed packages, for price predictability on both sides.',
      recommended: 'Recommended',
      ctaLabel: 'Get in Touch',
      alaCarteNote: 'Each item can also be hired on its own — get in touch to find out more.',
      tiers: [
        { name: 'Essential', scope: 'A solid, credible base for businesses that need it.' },
        { name: 'Growth', scope: 'Our most balanced package.' },
        { name: 'Full Digital', scope: 'Full presence, for businesses ready to scale.' },
      ],
      rows: [
        { label: 'Digital strategy', values: ['Basic', 'Complete', 'Strategic'] },
        { label: 'Website / digital presence', values: ['✓', '✓', '✓'] },
        { label: 'Social media', values: ['Basic', 'Complete', 'Complete'] },
        { label: 'Content', values: ['5–7 pieces/mo', '10–12 pieces/mo', '15+ pieces/mo'] },
        { label: 'Graphic design', values: ['✓', '✓', '✓'] },
        { label: 'Copywriting', values: ['Basic', '✓', '✓'] },
        { label: 'Editorial calendar', values: ['✓', '✓', '✓'] },
        { label: 'Publishing management', values: ['—', '✓', '✓'] },
        { label: 'Reporting', values: ['Quarterly', 'Monthly', 'Monthly'] },
        { label: 'Digital optimization', values: ['—', '✓', '✓'] },
        { label: 'Support', values: ['Standard', 'Priority', 'Priority'] },
      ],
    },
    operational: {
      kicker: 'Operational Identity',
      title: 'How your business runs on the inside',
      text: 'CRM, databases, dashboards, automation, and AI agents — always scoped and quoted per project, since complexity varies from business to business.',
      items: ['CRM & lead management', 'Dashboards & executive reporting', 'Process automation', 'AI agents', 'Platform integrations'],
    ...
    cases: {
      ...
      bannerCaption: 'From scattered processes to structured systems.',
      items: [
        {
          slug: 'bda',
  ...
  pt: {
    ...
    stats: {
      ...
      identity: {
        ...
        items: [
          { stat: '73%', desc: 'dos clientes duvidam da credibilidade após um mau website.' },
          { stat: '57%', desc: 'das empresas continuam invisíveis online, sem website.' },
          { stat: '88%', desc: 'dos clientes não voltam após uma má primeira experiência.' },
          { stat: '3h+', desc: 'perdidas em eficiência por semana com ferramentas desligadas.' },
        ],
      },
      analytics: {
        label: 'IA para departamentos de negócio',
        items: [
          { stat: '40%', desc: 'das empresas gastam mais tempo a processar dados manualmente do que a usá-los.' },
          { stat: '2,5x', desc: 'mais provável alcançar objectivos com dados em tempo real.' },
          { stat: '68%', desc: 'das empresas decidem "por intuição", não por dados.' },
          { stat: '1 em 3', desc: 'processos corporativos têm erros manuais.' },
        ],
      },
    },
    mission: {
    ...
    packages: {
      kicker: 'Pacotes de Identidade Digital',
      title: 'Três formas de estruturar a parceria',
      subtitle: 'Vendidos como pacotes fechados, para previsibilidade de preço para ambas as partes.',
      recommended: 'Recomendado',
      ctaLabel: 'Fale Connosco',
      alaCarteNote: 'Cada elemento pode também ser contratado de forma individual — fale connosco para saber mais.',
      tiers: [
        { name: 'Essencial', scope: 'Presença digital fundamental, para negócios que precisam de uma base sólida.' },
        { name: 'Crescimento', scope: 'O nosso pacote mais equilibrado.' },
        { name: 'Full Digital', scope: 'Presença completa, para negócios prontos para escalar.' },
      ],
      rows: [
        { label: 'Estratégia digital', values: ['Básica', 'Completa', 'Estratégica'] },
        { label: 'Website / presença digital', values: ['✓', '✓', '✓'] },
        { label: 'Social Media', values: ['Básica', 'Completa', 'Completa'] },
        { label: 'Conteúdo', values: ['5–7 peças/mês', '10–12 peças/mês', '15+ peças/mês'] },
        { label: 'Design gráfico', values: ['✓', '✓', '✓'] },
        { label: 'Copywriting', values: ['Básico', '✓', '✓'] },
        { label: 'Calendário editorial', values: ['✓', '✓', '✓'] },
        { label: 'Gestão de publicação', values: ['—', '✓', '✓'] },
        { label: 'Reporting', values: ['Trimestral', 'Mensal', 'Mensal'] },
        { label: 'Optimização digital', values: ['—', '✓', '✓'] },
        { label: 'Suporte', values: ['Standard', 'Prioritário', 'Prioritário'] },
      ],
    },
    operational: {
      kicker: 'Identidade Operacional',
      title: 'Como o seu negócio funciona por dentro',
      text: 'CRM, bases de dados, dashboards, automação e agentes de IA — sempre orçamentados por projecto, porque a complexidade varia de negócio para negócio.',
      items: ['CRM & gestão de leads', 'Dashboards & reporting executivo', 'Automação de processos', 'Agentes de IA', 'Integrações entre plataformas'],
      cta: 'Fale connosco sobre o seu projecto',
    ...
    cases: {
      ...
      bannerCaption: 'De processos dispersos a sistemas estruturados.',
      items: [
        {
          slug: 'bda',
