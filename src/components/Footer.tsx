...
import { CONTACT_EMAIL, LINKEDIN_URL, SERVICE_SLUGS } from '../i18n/translations'
            ...
            <ul className="mt-4 space-y-2.5">
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-[13px] text-charcoal/70 hover:text-red-primary"
                >
